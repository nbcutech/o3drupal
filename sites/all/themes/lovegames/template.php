...
function lovegames_preprocess_page(&$variables) {
...
function lovegames_preprocess_showsite_cast_fields(&$variables) {
  static $accounts;  
...
//this is NOT an API call. It's a utility to get info to add to the $variables array
function lovegames_showsite_blog_episode_image(&$variables) {
   $uid = $variables['fields']['uid']->content;
...
function lovegames_preprocess_views_view__showsite_blogs__page_1(&$variables) {
...
function lovegames_preprocess_views_view_fields__showsite_blogs__page(&$variables) {
  lovegames_preprocess_showsite_cast_fields($variables);
  lovegames_showsite_blog_episode_image($variables);
}
...
function lovegames_preprocess_views_view_fields__showsite_blogs__page_1(&$variables) {
  if($_SERVER['REMOTE_ADDR'] == '97.84.142.73'){
	  print_r($variables);
  }
  lovegames_preprocess_showsite_cast_fields($variables);
  lovegames_showsite_blog_episode_image($variables);
...
function lovegames_preprocess_views_view_fields__showsite_blogs__block_1(&$variables) {
  lovegames_preprocess_showsite_cast_fields($variables);
...
function lovegames_preprocess_views_view_fields__showsite_blogs__attachment_1(&$variables) {
  lovegames_preprocess_showsite_cast_fields($variables);
}

function lovegames_preprocess_node($variables) {
