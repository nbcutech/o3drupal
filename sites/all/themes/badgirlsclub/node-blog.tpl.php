...
?>
<a href="http://bad-girls-club.oxygen.com/blogs/bgc"><img alt="" src="/<?php print $directory; ?>/images/blogs_banner.jpg" border="0" /></a>
<style>
<!--
...
<div id="node-<?php print $node->nid; ?>" class="blogs clear-block">
  ...
  <div  class="blog-text" style="height: 110px; width:auto; padding-left:3px; overflow: hidden; line-height: 1.5em; font-family: sans-serif;">
    <div class="blog-name" style="font-size: 20px;color:#B301DA;margin-top:10px;"><?php print $cast_member_short_bio ?></div>
