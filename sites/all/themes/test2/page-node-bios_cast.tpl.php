...
<div id="container" class="bios_cast">
	...
	<div id="two_col_wrapper">
		<div id="sub_left_col">
			<div class="pageHeaderTXT"><img class="png" src="<?php print $pot;?>/images/<?php print strtr(strtolower($title)," ", "_");?>_TXT_header.png"></div>
			<div class="bioPic png"><img src="<?php print $pot;?>/images/<?php print strtr(strtolower($title)," ", "_");?>_BioPic.jpg"></div>
			<?php print $content; ?>
			<?php print $middle; ?>
		</div>
