...
<div id="container" class="blog">
	...
	<div id="wideLeft" >
		...
		<div class="copy" style="position:relative;z-index:10;">
		    <div id="sub_left_col">
			<div class="blogPic png"><img src="<?php print $pot;?>/images/blogs/166x235/<?php print strtolower($author_name->value);?>_166_235.jpg"></div>
...
<?php
    ...
    $contestants = array('Blythe','Calvin','Curtis','Emily','Eric','Kerri','Megan','Robyn','Sam','Claire');
    sort($contestants);
