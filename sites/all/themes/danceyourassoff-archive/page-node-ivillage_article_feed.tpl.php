    ...
    <div id="wrapper">
		<div id="wideLeft" >
			<div style="height:30px;position:relative;z-index:1;">
				<img style="position:absolute;" src="/sites/all/themes/danceyourassoff/images/fitness/NSD_articles_two_col_BG.png" class="png" usemap="#NSD_Map">
				<map name="NSD_Map">
			...
			<div id="wideLeftRepeater" style="background: url(/sites/all/themes/danceyourassoff/images/blogs/BGrepeater.jpg) repeat-y;">
				<div class="copy" style="position:relative;z-index:10;">
					...
					<?php print $content; ?>
					<div style="margin-top:15px;"><a href="/dyao/fit_club/articles"><img src="/sites/all/themes/danceyourassoff/images/fitness/back_to_art_button.gif" style="clear:both;" border="0"/></a></div>
