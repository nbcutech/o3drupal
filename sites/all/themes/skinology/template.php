...
function skinology_preprocess_page(&$variables) {
...
function skinology_preprocess_showsite_cast_fields(&$variables) {
  static $accounts;  
...
//this is NOT an API call. It's a utility to get info to add to the $variables array
function skinology_showsite_blog_episode_image(&$variables) {
  $uid = $variables['fields']['uid']->content;
...
function skinology_preprocess_views_view__showsite_blogs__page_1(&$variables) {
...
function skinology_preprocess_views_view_fields__showsite_blogs__page(&$variables) {
  skinology_preprocess_showsite_cast_fields($variables);
  skinology_showsite_blog_episode_image($variables);
}
...
function skinology_preprocess_views_view_fields__showsite_blogs__page_1(&$variables) {
  skinology_preprocess_showsite_cast_fields($variables);
  skinology_showsite_blog_episode_image($variables);
}
...
function skinology_preprocess_views_view_fields__showsite_blogs__attachment_1(&$variables) {
  skinology_preprocess_showsite_cast_fields($variables);
}

function skinology_preprocess_node($variables) {
