...
function houseofglam_preprocess_page(&$variables) {
...
function houseofglam_preprocess_showsite_cast_fields(&$variables) {
  static $accounts;  
...
//this is NOT an API call. It's a utility to get info to add to the $variables array
function houseofglam_showsite_blog_episode_image(&$variables) {
  $uid = $variables['fields']['uid']->content;
...
function houseofglam_preprocess_views_view__showsite_blogs__page_1(&$variables) {
...
function houseofglam_preprocess_views_view_fields__showsite_blogs__page(&$variables) {
  houseofglam_preprocess_showsite_cast_fields($variables);
  houseofglam_showsite_blog_episode_image($variables);
}
...
function houseofglam_preprocess_views_view_fields__showsite_blogs__page_1(&$variables) {
  houseofglam_preprocess_showsite_cast_fields($variables);
  houseofglam_showsite_blog_episode_image($variables);
}
...
function houseofglam_preprocess_views_view_fields__showsite_blogs__block_1(&$variables) {
  houseofglam_preprocess_showsite_cast_fields($variables);
...
function houseofglam_preprocess_views_view_fields__showsite_blogs__attachment_1(&$variables) {
  houseofglam_preprocess_showsite_cast_fields($variables);
}

function houseofglam_preprocess_node($variables) {
...
function houseofglam_preprocess_allsite_cast_fields(&$variables) {
  static $accounts;  
  $uid = $variables['fields']['uid']->content; 
  if (is_null($accounts[$uid])) {
  	$cast_query = db_query('select * from content_type_bios_cast where field_uid_uid = %d', $uid);
...
function houseofglam_preprocess_allsite_cast_fields_attachment(&$variables) {
  static $accounts;  
  $uid = $variables['fields']['uid']->content; 
  if (is_null($accounts[$uid])) {
  	$cast_query = db_query('select * from content_type_bios_cast where field_uid_uid = %d', $uid);
...
function houseofglam_allsite_blog_episode_image(&$variables) { //print_r($variables['fields']);
  $uid = $variables['fields']['uid']->content;
  preg_match('#<img\s+.*src=[\"\']([^>\"\']+)[\"\'].*[^>]*>#i', $variables['fields']['body']->raw, $matched);  
  if ($matched[1]) {
    // $matched[0] is the whole image tag. $match[1] is the captured src attribute "([^>\"\']+)"  	
...
function houseofglam_preprocess_views_view__allsite_blogs__page_1(&$variables) {
  // the entire view view is in $variables['view'], the array of query result is in $variables['view']->result
  $blog_rec = $variables['view']->result[0];
  $cast_query = db_query('select * from content_type_bios_cast where field_uid_uid = %d', $blog_rec->users_uid);
  $account = db_fetch_object($cast_query);
...
function houseofglam_preprocess_views_view__allsite_blogsv2__page_1(&$variables) {
  // the entire view view is in $variables['view'], the array of query result is in $variables['view']->result
  $blog_rec = $variables['view']->result[0];
  $cast_query = db_query('select * from content_type_bios_cast where field_uid_uid = %d', $blog_rec->users_uid);
  $account = db_fetch_object($cast_query);
...
function houseofglam_preprocess_views_view__allsite_blogsv2__page(&$variables) {
  // the entire view view is in $variables['view'], the array of query result is in $variables['view']->result
  $blog_rec = $variables['view']->result[0];
  $cast_query = db_query('select * from content_type_bios_cast where field_uid_uid = %d', $blog_rec->users_uid);
  $account = db_fetch_object($cast_query);
...
function houseofglam_preprocess_views_view_fields__allsite_blogs__page(&$variables) { //print_r($variables);
  houseofglam_preprocess_allsite_cast_fields($variables);
  houseofglam_allsite_blog_episode_image($variables);
}

function houseofglam_preprocess_views_view_fields__allsite_blogsv2__page(&$variables) { //print_r($variables);
  houseofglam_preprocess_allsite_cast_fields($variables);
  houseofglam_allsite_blog_episode_image($variables);
}

function houseofglam_preprocess_views_view_fields__allsite_blogs__page_1(&$variables) {
  houseofglam_preprocess_allsite_cast_fields($variables);
  houseofglam_allsite_blog_episode_image($variables);
}

function houseofglam_preprocess_views_view_fields__allsite_blogsv2__page_1(&$variables) {
  houseofglam_preprocess_allsite_cast_fields($variables);
  houseofglam_allsite_blog_episode_image($variables);
}

function houseofglam_preprocess_views_view_fields__allsite_blogs__attachment_1(&$variables) { 
  houseofglam_preprocess_allsite_cast_fields_attachment($variables);
}

function houseofglam_preprocess_views_view_fields__allsite_blogsv2__attachment(&$variables) { 
  houseofglam_preprocess_allsite_cast_fields_attachment($variables);
}
