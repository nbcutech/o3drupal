...
#contentHeader {
    background: url("/sites/all/themes/features/images/main2colBG_blog.jpg") no-repeat scroll 0 0 transparent;
    display: block;
    height: 75px;
    width: 672px;
}
#wrapper {
	background: url("/sites/all/themes/features/images/interior_content_BG.jpg") no-repeat scroll left top #FFFFFF;
}
#wideLeft .copy {
	padding: 0;
}
...
<div class="clear-block view view-<?php print $css_name; ?> view-id-<?php print $name; ?> view-display-id-<?php print $display_id; ?> view-dom-id-<?php print $dom_id; ?>">
  ...
  <?php if ($attachment_before): ?>
    <div class="attachment-before">
	   <div class="clear-block view  view-id-<?php print $name; ?> view-dom-id-<?php print $dom_id; ?>">
		  <div class="blog_section_title">featured blogs</div>
          <div class="feature_blog_block">
			 	<div class="view view-id-<?php print $name; ?> view-dom-id-<?php print $dom_id; ?>">
