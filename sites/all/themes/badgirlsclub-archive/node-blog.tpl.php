...
<div id="node-<?php print $node->nid; ?>" class="blogs clear-block">
  ...
  <div  class="blog-text" style="height: 110px; width:auto; padding-left:3px; overflow: hidden; line-height: 1.5em; font-family: sans-serif;">
    <div class="blog-name" style="font-size: 20px;color:fuchsia;"><?php print $cast_member_name ?></div>
    <div class="blog-title" style="font-size: 12px;font-weight:bold; color:black;"><?php print $title ?></div>
    <div class="blog-teaser" style="font-size: 12px; font-weight:bold; color:grey; "><?php print format_date($created, 'custom', 'M j, Y'); ?></div>
    <div class="blog-teaser" style="font-size: 11px; "><a href="/blogs/<?php print $blogpath .'/'. $alias_parts[2]; ?>">view all postings</a></div>
  </div>
