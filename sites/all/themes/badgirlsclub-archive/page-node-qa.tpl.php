		...
		<div id="wideLeft" >
			<div id="wideLeftContent">
				...
				<div class="copy">
					...
					<div id="sub_left_col">
						<div class="qaPic png"><img src="<?php print $pot;?>/images/blogs/166x235/<?php print $node->field_image_qa_name[0]['value'];?>_166_235.jpg"></div>
						<div class="biosCastLink"><a href="/meet-the-cast-bgc/<?php print $node->field_image_qa_name[0]['value'];?>-bio"> &#9664; back to bio page</a></div>
					</div>
