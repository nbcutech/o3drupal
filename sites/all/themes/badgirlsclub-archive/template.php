...
function badgirlsclub-archive_preprocess_page(&$variables) {
...
function badgirlsclub-archive_preprocess_showsite_cast_fields(&$variables) {
  static $accounts;  
...
//this is NOT an API call. It's a utility to get info to add to the $variables array
function badgirlsclub-archive_showsite_blog_episode_image(&$variables) {
  $uid = $variables['fields']['uid']->content;
...
function badgirlsclub-archive_preprocess_views_view__showsite_blogs__page_1(&$variables) {
...
function badgirlsclub-archive_preprocess_views_view_fields__showsite_blogs__page(&$variables) {
  badgirlsclub-archive_preprocess_showsite_cast_fields($variables);
  badgirlsclub-archive_showsite_blog_episode_image($variables);
}
...
function badgirlsclub-archive_preprocess_views_view_fields__showsite_blogs__page_1(&$variables) {
  badgirlsclub-archive_preprocess_showsite_cast_fields($variables);
  badgirlsclub-archive_showsite_blog_episode_image($variables);
}
...
function badgirlsclub-archive_preprocess_views_view_fields__showsite_blogs__block_1(&$variables) {
  badgirlsclub-archive_preprocess_showsite_cast_fields($variables);
...
function badgirlsclub-archive_preprocess_views_view_fields__showsite_blogs__attachment_1(&$variables) {
  badgirlsclub-archive_preprocess_showsite_cast_fields($variables);
}

function badgirlsclub-archive_preprocess_node($variables) {
