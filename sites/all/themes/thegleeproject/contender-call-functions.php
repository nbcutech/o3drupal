...
Class ContenderCall {
	...
	function submit(){
		...
		$sql = "Insert into tgp_contender_call_sweepstake (`firstName` , `lastName` , `address` , `city` , `state` , `zipcode` , `email` , `phone` , `age` , `tv_service_provider` , `watch_oxygen` , `internet` , `code_word` , `newsletter`) values ('$firstName' , '$lastName' , '$address' , '$city' , '$state' , '$zipcode' , '$email' , '$phone' , '$age' , '$tv_service_provider' , '$watch_oxygen' , '$internet' , '$code_word' , '$newsletter')";
		mysql_query($sql);
