...
if($_COOKIE['theglee_voting']) {
  ...
  $tweet_text = 'I voted for '.$label.' in the Bing Fan Favorite poll!Vote for your fav #TheGleeProject contender: via @TheGleeProject';
	...
	$fb_share_text = 'Thanks for voting in the Bing Fan Favorite poll. See which contender got the fan vote and find out how you can watch their special 
performance';
  $tweet_text = 'See which contender won  #TheGleeProject Bing Fan Favorite: via @TheGleeProject';
}
	...
	<div class="left-panel">
		<div class="bing-contest-header">
			  ...
			  <div class="twitter-share">
					<a href="" class="twitter-share-button" data-count="none" data-text="See which contender won #TheGleeProject Bing Fan Favorite: " 
...
document.write('<sc'+'ript language=\'JavaScript1.1\' src="http://ad.doubleclick.net/adj/nbcu.oxygen/bingfanfavorite_242077344aug29;site=oxygen;sect=bingfanfavorite;sub=242077344aug29;genre=;daypart=primetime;!category=bingfanfavorite;!category=js;!category=oxygen;network=tvn;sz=1x1;tagtype=js;uri=;pos=9;tile=9;ord=' + randDARTNumber + '?"></s'+'cript>');
				...
				<div class="fb-share" id="facebookshare">
					...
					<meta name="title" content="See which contender won The Glee Project Bing Fan Favorite"></meta>
				...
				<div class="description">
						<div class="desc-wrapper">
							Vote each week for your favorite contender. The winning cast member will win $10,000 and a live performance!
	...
	<div class="contest-results">
		...
		<input type="hidden" name="voting_active" id="voting_active" value="true" />
