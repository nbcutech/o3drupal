...
function jerseycouture_preprocess_page(&$variables) {
...
function jerseycouture_preprocess_showsite_cast_fields(&$variables) {
  static $accounts;  
...
//this is NOT an API call. It's a utility to get info to add to the $variables array
function jerseycouture_showsite_blog_episode_image(&$variables) {
  $uid = $variables['fields']['uid']->content;
...
function jerseycouture_preprocess_views_view__showsite_blogs__page_1(&$variables) {
...
function jerseycouture_preprocess_views_view_fields__showsite_blogs__page(&$variables) {
  jerseycouture_preprocess_showsite_cast_fields($variables);
  jerseycouture_showsite_blog_episode_image($variables);
}
...
function jerseycouture_preprocess_views_view_fields__showsite_blogs__page_1(&$variables) {
  jerseycouture_preprocess_showsite_cast_fields($variables);
  jerseycouture_showsite_blog_episode_image($variables);
}
...
function jerseycouture_preprocess_views_view_fields__showsite_blogs__block_1(&$variables) {
  jerseycouture_preprocess_showsite_cast_fields($variables);
...
function jerseycouture_preprocess_views_view_fields__showsite_blogs__attachment_1(&$variables) {
  jerseycouture_preprocess_showsite_cast_fields($variables);
}

function jerseycouture_preprocess_node($variables) {
...
function jerseycouture_fluff_me_photo_node_form($form) {
