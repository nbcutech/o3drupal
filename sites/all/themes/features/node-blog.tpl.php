...
?>
<?php /*** Temporarily blocking image
...
#contentHeader 
{
background:url("/sites/all/themes/features/images/out_loud_header.png") repeat scroll 0 0 transparent;
width: 676px;
}
<!--
...
-->
  <div  class="blog-text" style=" width:auto; padding-left:3px; overflow: hidden; line-height: 1.5em; font-family: sans-serif;margin-top: 75px;">
<!--
    <div class="blog-name" style="font-size: 20px;color:#63349c;"><?php print $cast_member_name ?></div>
-->
    <div class="blog-title" style="font-size: 24px;font-weight:bold; color:black;"><?php print $title ?></div>
    <div class="blog-name" style="font-size: 14px;color:#63349c;">By Oxygen Editor</div>
