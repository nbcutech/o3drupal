<div class="attach-row clear-block more-blogs-row">
  ...
  <div  class="bloglist-row-text">
    <div class="bloglist-row-name"><a class="sectColor-<?php print $cast_member_name ?>" href="http://features.oxygen.com/blogs/outloud/<?php print $cast_member_name ?>"><?php print $cast_member_name ?></a></div>
