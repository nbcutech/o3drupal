<div class="attach-row clear-block">
  <div class="bloglist-row-image-frame png">
  	<a href="<?php print $showsite_blogs_url ?>">
	  <img alt="" src="/<?php print $cast_member_picture ?>" class="bloglist-row-image" border="0" />
	  </a>
  </div>
  ...
  <br class="clearfloat" />
  <a class="showsite_blog_link" href="<?php print $showsite_blogs_url ?>">Click here for all blogs: <br /><?php print $showsite_name ?></a>
</div>