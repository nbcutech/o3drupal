	...
	function galleryMoveLeft(){
  		...
  		if(currentPhotoIndex ==firstPhotoIndex)
  		{
      			currentPhotoIndex = lastPhotoIndex;
					...
					if($(photosArray[currentPhotoIndex]).attr("href") == '/sites/default/files/images/tumblr_lngpcnbvAc1qm43kso1_500_0.jpg'){
  		...
  		updateSponsorScript();
			...
			if(typeof Meebo=='function') Meebo('makeEverythingSharable', {title:document.title});
...
//	}
	...
	if(typeof Meebo=='function'){
		$('#largeImage').load(function() {
			Meebo('makeEverythingSharable', {title:document.title});
		});
	}
