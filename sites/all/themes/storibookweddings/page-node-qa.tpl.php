...
.png" width="289" height="54" class="png" /></div>
					<div id="sub_left_col">
						<div class="qaPic png"><img src="<?php print $pot;?>/images/bios/photo_<?php print $node->field_image_qa_name[0]['value'];?>.jpg" /></div>
						<div class="biosCastLink"><a href="/meet-the-cast-bgc/<?php print $node->field_image_qa_name[0]['value'];?>"> &#9664; back to bio page</a></div>
					</div>
