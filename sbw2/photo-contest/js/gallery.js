...
(function($) {
	Gallery = {
		...
		thumbSelect: function (el) {
			...
			this.currentImage.permLink = window.location.protocol + "//" + window.location.host + window.location.pathname + "?ugcId=" + data.id;
			
			this.updateShare();
			
			$("#gallery_viewer img").attr({src: "images/ajax-loader_full.gif"});
		...
		updateShare: function () {
			...
			sharebox = '\
				<div class="addthis_toolbox addthis_default_style " \
				   addthis:url="{photo_url}" \
				   addthis:title="{photo_title}" \
				   addthis:description="{photo_description}"> \
				<a class="addthis_button_facebook_like" fb:like:layout="button_count"></a> \
				<a class="addthis_button_tweet"></a> \
				</div>';
			sharebox = sharebox.replace(/{photo_url}/gi, this.currentImage.permLink);
			sharebox = sharebox.replace(/{photo_title}/gi, this.currentImage.title);
			sharebox = sharebox.replace(/{photo_description}/gi, this.currentImage.description);
			$(".social_box").append(sharebox);
			facebook = {
