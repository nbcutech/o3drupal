<?php
		...
		$upload_notify_email = 'sudha.kota@nbcuni.com' ;  	// enter your valid email address
		
		$upload_directory = '/mnt/docroots/oxygen/sites/default/files/oxgn-homepage/promo1/' ; // leave blank for default
